        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="p-6 border-t border-gray-200 bg-gray-50 flex justify-end gap-4">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl text-sm font-medium hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg"
            >
      ...
      {showConfirmation && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-6 max-w-sm w-full shadow-xl">
            ...
            <p className="text-slate-600 mb-6">Are you sure you want to {isEditMode ? 'update' : 'add'} this staff member?</p>
